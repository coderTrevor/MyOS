...
int SDL_MYOS_CreateWindowFramebuffer(_THIS, SDL_Window * window, Uint32 * format, void ** pixels, int *pitch)
{
    ...
    surface = (SDL_Surface *) SDL_GetWindowData(window, MYOS_SURFACE);
    ...
    SDL_SetWindowData(window, MYOS_SURFACE, surface);
...
int SDL_MYOS_UpdateWindowFramebuffer(_THIS, SDL_Window * window, const SDL_Rect * rects, int numrects)
{
...
void SDL_MYOS_DestroyWindowFramebuffer(_THIS, SDL_Window * window)
{
    SDL_Surface *surface;

    surface = (SDL_Surface *) SDL_SetWindowData(window, MYOS_SURFACE, NULL);
    SDL_FreeSurface(surface);
}
